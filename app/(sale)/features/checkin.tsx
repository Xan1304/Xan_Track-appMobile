...
import { StoreCheckinCard } from '../../../src/components/checkin/StoreCheckinCard';
...
export default function CheckinPage() {
  ...
  const {
    ...
    takePicture,
    handleFinalCheckin
  } = useCheckin(id as string, name as string, addr as string, dist as string);
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <StoreCheckinCard 
          ...
          addr={addr as string}
          isInRange={isInRange}
          distanceInfo={`${Math.round(distanceNumber)}m`}
        />
        ...
        {!isInRange && (
          <View style={styles.warningBar}>
            ...
            <Text style={styles.warningText}>
              Bạn cách cửa hàng {Math.round(distanceNumber)}m — cần ở trong vòng 50m để check-in
            </Text>
          </View>
        )}
