    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.profileHero}>
        ...
        <View style={styles.roleBadge}>
          <Text style={styles.roleText}>{profile?.chuc_vu || 'Quản lý'}</Text>
...
const styles = StyleSheet.create({
  ...
  header: { paddingHorizontal: 18, paddingVertical: 16, backgroundColor: '#fff', borderBottomWidth: 0.5, borderBottomColor: 'rgba(0,0,0,0.08)', alignItems: 'center' },
  headerTitle: { fontSize: 16, fontWeight: '600', color: '#0f172a' },
  profileHero: { backgroundColor: '#fff', alignItems: 'center', paddingVertical: 28, borderBottomWidth: 0.5, borderBottomColor: 'rgba(0,0,0,0.06)' },
  avatarWrap: { position: 'relative', marginBottom: 14 },
  avatar: { width: 72, height: 72, borderRadius: 18, backgroundColor: NAVY, justifyContent: 'center', alignItems: 'center', borderWidth: 2, borderColor: 'rgba(26,58,107,0.2)' },
  avatarText: { color: '#fff', fontSize: 26, fontWeight: '600', letterSpacing: 0.5 },
  statusDot: { position: 'absolute', bottom: 0, right: 0, width: 14, height: 14, borderRadius: 7, backgroundColor: '#22c55e', borderWidth: 2.5, borderColor: '#fff' },
  name: { fontSize: 20, fontWeight: '600', color: '#0f172a', marginBottom: 8 },
  roleBadge: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#f0f4ff', paddingHorizontal: 14, paddingVertical: 6, borderRadius: 20 },
  ...
  infoCard: { backgroundColor: '#fff', borderRadius: 14, borderWidth: 0.5, borderColor: 'rgba(0,0,0,0.08)', padding: 4 },
  infoRow: { flexDirection: 'row', alignItems: 'center', padding: 12, gap: 12 },
  infoIcon: { width: 36, height: 36, borderRadius: 9, justifyContent: 'center', alignItems: 'center' },
  infoContent: { flex: 1 },
  ...
  logoutBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, padding: 15, borderRadius: 14, backgroundColor: '#fff', borderWidth: 0.5, borderColor: 'rgba(239,68,68,0.3)' },
